...
if (edad > 18) {
  if (promedio >= 9.0 && promedio <= 7.5)
    alert('Usted obtiene una beca de $200.000')
  if (promedio >= 7.5 && promedio <= 6.0)
    alert('usted obtiene uan beca de $100.000')
  if (promedio >= 6.0 && promedio < 7.5)
    alert('Usted obtiene una beca de $50.000')
} else {
  if (edad <= 18) {
    if (promedio >= 9.0 && promedio < 8.0)
      alert('Usted obtiene una beca de $300.000')
    if (promedio >= 8.0) alert('Usted obtiene una beca de $200.000')
    if (promedio >= 6.0) alert('Usted obtiene una beca de $100.000')
  } else if (
    console.log(
